...
//    @Builder
    public ImageLoggingDto(Long idx, Long memberIdx, String savedPath, Gps gps, String originalCaption, int factor1, int factor2, int factor3, int factor4, int factor5) {
        this.idx = idx;
